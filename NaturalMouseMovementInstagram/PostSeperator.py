...
coordsOfTargetButtonCenter = (1853, 547)  # replace with x,y the correct coords on desktop
radiusTargetButton = 29 # likewise as line above
...
while foreverLoop:
    ...
    time.sleep(0.03) # sleep of 0.03 seconds between point recordings so I don't game end the cpu
